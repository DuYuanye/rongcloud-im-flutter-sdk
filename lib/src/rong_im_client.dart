...
//  }
  ...
  static Future<void> removeConversation(int conversationType, String targetId,
...
//  从服务端同步失败的时候会返回非 0 的 errorCode，同时把本地能取到的消息回调上去。
 ...
 @remarks 消息操作
 */
  static Future<void> batchInsertMessage(
  ...
  ///
  /// [targetId] 会话 id
  static Future<void> deleteMessages(int conversationType, String targetId,
  ...
  static Future<void> deleteMessageByIds(
  ...
  static Future<void> getTotalUnreadCount(
  ...
  ///
  /// [finished] 回调结果，code 为 0 代表正常
  static Future<void> getUnreadCount(int conversationType, String targetId,
      Function(int? count, int? code)? finished) async {
    Map map = {"conversationType": conversationType, "targetId": targetId};
    Map? unreadMap =
  ...
  ///
  /// [finished] 回调结果，code 为 0 代表正常
  static Future<void> getUnreadCountConversationTypeList(List<int> conversationTypeList,
  ...
  ///
  /// [finished] 回调结果，status 参见 [RCConversationNotificationStatus]，code 为 0 代表正常
  static Future<void> getConversationNotificationStatus(int conversationType,
  ...
  ///
  /// [finished] 回调结果，code 为 0 代表正常
  static Future<void> setConversationToTop(int conversationType, String targetId,
...
//  }
  ...
  static Future<void> getBlackListStatus(String userId,
  ...
  static Future<void> getBlackList(
  ...
  /// [finished] 回调结果，code 为 0 代表操作成功，其他值代表失败
  /// 此接口只支持单聊
  static Future<void> sendReadReceiptMessage(int conversationType, String targetId,
  ...
  /// [finished] 回调结果，code 为 0 代表操作成功，其他值代表失败
  /// 此接口只支持群组
  static Future<void> sendReadReceiptRequest(
  ...
  /// [finished] 回调结果，code 为 0 代表操作成功，其他值代表失败
  /// 此接口只支持群组
  static Future<void> sendReadReceiptResponse(int conversationType, String targetId,
  ...
  /// [finished] 回调结果，code 为 0 代表操作成功，其他值代表失败
  ///
  static Future<void> syncConversationReadStatus(int conversationType, String targetId,
      int timestamp, Function(int? code)? finished) async {
    Map map = {
      "conversationType": conversationType,
      "targetId": targetId,
  ...
  static Future<void> setNotificationQuietHours(
  ...
  /// [finished] 回调结果，code 为 0 代表操作成功，其他值代表失败
  ///
  static Future<void> removeNotificationQuietHours(
      Function(int? code)? finished) async {
    int? result =
  ...
  ///
  static Future<void> getNotificationQuietHours(
  ...
  /// 此接口只支持聊天室，必须先开通聊天室属性自定义功能
  static Future<void> getChatRoomEntry(String chatRoomId, String key,
  ...
  /// [finished] 回调结果，code 为 0 代表操作成功，其他值代表失败，entry 为返回的 map
  /// 此接口只支持聊天室，必须先开通聊天室属性自定义功能
  static Future<void> getAllChatRoomEntries(
  ...
  /// [finished] 回调结果，code 为 0 代表操作成功，其他值代表失败
  /// 此接口只支持聊天室，必须先开通聊天室属性自定义功能
  static Future<void> removeChatRoomEntry(
      String chatRoomId,
      String key,
      bool sendNotification,
      String notificationExtra,
  ...
  /// [finished] 回调结果，code 为 0 代表操作成功，其他值代表失败
  /// 此接口只支持聊天室，必须先开通聊天室属性自定义功能
  static Future<void> forceRemoveChatRoomEntry(
      String chatRoomId,
      String key,
      bool sendNotification,
      String notificationExtra,
  ...
  /// 会话类型, 不支持聊天室
  static Future<void> deleteRemoteMessages(int? conversationType, String? targetId,
  ...
  static Future<void> clearMessages(int? conversationType, String? targetId,
      Function(int? code)? finished) async {
    if (conversationType == null || targetId == null) {
      developer.log(
  ...
  /// 设置本地消息的附加信息
  static Future<void> setMessageExtra(
  ...
  static Future<void> setMessageReceivedStatus(
  ...
  static Future<void> setMessageSentStatus(
  ...
  static Future<void> setOfflineMessageDuration(
  ...
  static Future<void> getRemoteChatRoomHistoryMessages(
      String targetId,
      int recordTime,
      int count,
